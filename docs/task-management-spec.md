...
Trelloのボード共有に近い仕組み。チーム・部署・プロジェクトチーム単位でグループボードを作成し、メンバーを招待してタスクを共有する。
...
- スコープ切替: 全社 / 事業別 / マイタスク / **グループボードタブ**（参加中ボード一覧）
