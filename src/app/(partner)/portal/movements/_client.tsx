...
import { ArrowUpDown, ArrowUp, ArrowDown, BarChart3, CheckCircle, Circle, Play, SkipForward, XCircle } from 'lucide-react';
                ...
                {templates.map((template) => {
                  ...
                  return (
                    <div
                      key={template.id}
                      className={cn(
                        'w-[120px] sm:w-[140px] shrink-0 px-2 py-3 border-r flex flex-col items-center justify-center relative',
                        config.bg,
