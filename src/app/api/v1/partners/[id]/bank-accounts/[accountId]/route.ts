...
// ============================================
// PATCH /api/v1/partners/:id/bank-accounts/:accountId
// ============================================
...
export async function PATCH(
  ...
  try {
    ...
    if (isNaN(partnerId) || isNaN(accountIdNum)) throw ApiError.notFound('口座情報が見つかりません');

    const existing = await prisma.partnerBankAccount.findFirst({
      where: { id: accountIdNum, partnerId },
    });
...
// ============================================
// DELETE /api/v1/partners/:id/bank-accounts/:accountId
// ============================================
...
export async function DELETE(
  ...
  try {
    ...
    await prisma.partnerBankAccount.delete({ where: { id: accountIdNum } });
