...
export const partnerListConfig: EntityListConfig = {
  ...
  columns: [
    ...
    { key: 'partnerCorporateNumber', label: '法人番号', width: 150, sortable: true, defaultVisible: false, group: '企業情報', edit: { type: 'text', placeholder: '13桁の数字' } },
    { key: 'partnerInvoiceNumber', label: 'インボイス番号', width: 160, sortable: true, defaultVisible: false, group: '企業情報', edit: { type: 'text', placeholder: 'T + 13桁の数字' } },
    {
      key: 'partnerCapital',
      label: '資本金',
      width: 140,
